...
function render_confirm_modal_html_alert() {
    ?>
    <div class="modal fade confirm_modal_html_alert" id="modal_html_alert" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
function render_modal_html_alert() {
    ?>
       <div class="modal fade modal_html_alert" id="modal_html_alert" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
