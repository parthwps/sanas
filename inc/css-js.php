...
function sanas_css()
{
  ...
  if(is_page_template('page-template/todolist.php') || is_page_template('page-template/my-vendors.php') || is_page_template('page-template/vendor-list.php') || is_page_template('page-template/mycontact.php')){
    wp_enqueue_style('datatables', get_template_directory_uri() . '/assets/css/datatables.min.css', array(), SANAS_VERSION);
  }
