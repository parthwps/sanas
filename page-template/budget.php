          ...
          <div class="lower-box">
            <div class="info-box">
              <div class="cat-info">
                ...
                <div class="cost">
                  <span class="c-text">Estimated cost: <span class="category_estimated">$<?php echo $totals->total_estimated; ?></span></span>
                  <span class="c-text">Actual cost: <span class="category_actual">$<?php echo $totals->total_actual; ?></span></span>
                </div>
              </div>
            </div>
