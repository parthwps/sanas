          ...
          <div class="lower-box">
            ...
            <div class="table-box upcoming-tasks">
              <div class="table-responsive">
                <table class="vendor-table budget-table-sort" id="budget-expense">
                  <thead>
                    <tr>
                    ...
                    if (!empty($expenses)) {
                        foreach ($expenses as $expense) {
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    <a href="#" class="edit-expense theme-btn" data-id="<?php echo esc_attr($expense['id']); ?>" data-bs-toggle="modal" data-bs-target="#edit-expense-popup">
