                    ...
                    if (!empty($expenses)) {
                        foreach ($expenses as $expense) {
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    <a href="#" class="edit theme-btn"  data-id="<?php echo esc_attr($expense['id']); ?>" data-category-id="<?php echo esc_attr($expense['category_id']); ?>" data-bs-toggle="modal" data-bs-target="#edit-expense-popup">
