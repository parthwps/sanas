    ...
    <div class="container-fluid wl-dashboard-content">
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="page-header d-flex align-items-baseline gap-4">
            <h3 class="pageheader-title m-0">Vendors List</h3>
            <p class="m-0">Add your party vendors, then move your selcted vendors to the "My Vendors" Page.</p>
          </div>
        </div>
      </div>
      <div class="vendor">
                        ...
                        <?php if ($vendor_items): ?>
                            <?php foreach ($vendor_items as $vendor): ?>
                                <tr>
                                    ...
                                    <td class="text-single-line"><?php echo esc_html($vendor['category']); ?></td>
                                    <td class="text-single-line"><?php echo esc_html($vendor['name']); ?></td>
                                    <td class="text-single-line"><?php echo esc_html($vendor['email']); ?></td>
