                ...
                <div class="content content-3">
                    ...
                    <?php } ?>
                            <div class="row">
                                ...
                                <div class="rsvp-from-group">
                                    <input type="text" id="eventtitle" class="edit-text rsvp-msg event-title" name="eventtitle"
                        ...
                        <div class="row">
                            <div class="col-xxl-4 col-xl-5 col-lg-7 col-md-8 col-sm-12 m-auto">
                                <div class="wl-fuc-timing form-field">
                                     ...
                                     <table id="program-time" class="rsvp-event">
                                        <tbody>
                                                <?php 
                                    ...
                                    <?php endforeach; }
                                        ...
                                        ?>
                                          <tr>
                                              ...
                                              <td class="edit-text" contenteditable="true">7:00 PM</td>
                                              <td>
                                                <button class="deleteRowBtn"><i class="fa-regular fa-trash-can"></i></button>
                                             </td>
                                             </tr>
