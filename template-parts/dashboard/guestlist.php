              ...
              <div class="form-content last">
                <div class="row">
                  ...
                  <div class="col-lg-6 col-sm-6">
                    <div class="links-box">
                      <button type="submit" id="add_guest_details" event-id="<?php echo $event_id ?>" class="btn btn-secondary btn-block">Save</button>
                    </div>
                  </div>
                  <div class="col-lg-6 col-sm-6">
                    <div class="links-box">
                      <button type="button" id="add_guest_details_save" event-id="<?php echo $event_id ?>" class="btn btn-secondary btn-block">Save and Guest Add</button>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content upload-csv-box">
        ...
        <div class="modal-body">
          ...
          <p>Use Sana’s template worksheet and enter your guest names, emails and phone number in the specified format
          </p>
  ...
  <div class="modal fade" id="shareModal" tabindex="-1"  aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content" style="background-image: url(<?php echo  get_template_directory_uri(); ?>/assets/img/sher-link-bg.png);">
        ...
        <div class="url">
            <p>https://www.buymeacoffee.com/kloud23</p>
          </div>
        </div>
