                ...
                <div class="tab-pane fade active show" id="v-pills-text" role="tabpanel"
                    ...
                    <?php 
                        ...
                        <div class="form-text-edit">
                                ...
                                <button class="btn btn-secondary btn-block canavas-editor-btn" onclick="addText('event')">Add Text</button>
                                </div>                                
                                <div class="form-group-fluid">
...
<?php $data = !empty($frontpagedata) ? $frontpagedata : $frontmetadata;
...
<script type="text/javascript">
    var phpCanvasData = <?php echo json_encode($data); ?>;
