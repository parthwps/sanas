...
if (window.location.pathname === '/budget/') {
    ...
    jQuery('.clear-budget-btn').on('click', function() {
        ...
        $('.clear-budget-confirmation-modal #modal-body-text').text('Do you want to clear all expenses?');
        $('.clear-budget-confirmation-modal #modal-yes-button').id('render-modal-yes-button');
